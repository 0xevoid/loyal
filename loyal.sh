...
echo  " |  \/  |    |  __ \             | |     | |  ";
echo  " | \  / |_ __| |__) |__ _ __   __| | ___ | |  ";
echo  " | |\/| | '__|  ___/ _ \ '_ \ / _` |/ _ \| |  ";
echo  " | |  | | |_ | |  |  __/ | | | (_| | (_) | |  ";
echo  " |_|  |_|_(_)|_|   \___|_| |_|\__,_|\___/|_|  ";
echo 
echo -e "\e[0m"
echo "=====================================================================================================================================" 
...
if [ ! $LYL_NODENAME ]; then
	read -p "Enter your Node Name: " LYL_NODENAME
	echo 'export LYL_NODENAME='$LYL_NODENAME >> $HOME/.bash_profile
fi

echo -e "Node Name: \e[1m\e[32m$LYL_NODENAME\e[0m"
echo -e "Wallet Name: \e[1m\e[32m$LYL_WALLET\e[0m"
